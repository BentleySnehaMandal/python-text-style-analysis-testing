...
def adjust_font_size(chars):
    ...
    for word in grouped_words:
        ...
        word_info = {
            'fontname':reference_style['fontname'],  
            'size': average_font_size,
            'stroking_color': reference_style['stroking_color'],
            'non_stroking_color': reference_style['non_stroking_color'],
            'x0':word[0]['x0'],
            'x1': word[-1]['x1'],
            'y0': min(char['y0'] for char in word),
            'y1': max(char['y1'] for char in word),
            'top': min(char['top'] for char in word),
            'bottom': max(char['bottom'] for char in word),
            'skew_angle': reference_style['skew_angle'],
            'page_number': reference_style['page_number']
        }
