...
def process_fonts(report):
    ...
    return font_style_frequency, font_character_frequency
...
def open_files():
    ...
    if file_paths:
        ...
        # Process fonts
        font_style_frequency, font_character_frequency = process_fonts(combined_report)
...
open_button = tk.Button(root, text="Open PDFs", command=open_files)
